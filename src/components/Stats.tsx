  ...
  return (
    <section className="relative grad-brand-2 overflow-hidden">
      ...
      <div className="relative max-w-[1280px] mx-auto px-6 py-14 md:py-20 grid grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8">
        <Stat value={12500} suffix="+" label="Designs Delivered" sub="Digitizing, vector & patches shipped" />
        <Stat value={4200} suffix="+" label="Happy Clients" sub="Apparel brands & embroidery shops" />
        <Stat value={49} suffix=" /5" label="Avg. Client Rating" sub="Based on 980+ verified reviews" />
